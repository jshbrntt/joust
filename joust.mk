...
JOUST_MAME_PACKAGE_DIRECTORY := $(JOUST_ROM_DIRECTORY)/mame-joust
JOUST_MAME_REWRITE_ROM_PAIRS := \
$(JOUST_ROM_DIRECTORY)/3006-13.1b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_1b_3006-13.e4 \
$(JOUST_ROM_DIRECTORY)/3006-14.2b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_2b_3006-14.c4 \
$(JOUST_ROM_DIRECTORY)/3006-15.3b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_3b_3006-15.a4 \
$(JOUST_ROM_DIRECTORY)/3006-16.4b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_4b_3006-16.e5 \
$(JOUST_ROM_DIRECTORY)/3006-17.5b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_5b_3006-17.c5 \
$(JOUST_ROM_DIRECTORY)/3006-18.6b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_6b_3006-18.a5 \
$(JOUST_ROM_DIRECTORY)/3006-19.7b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_7b_3006-19.e6 \
$(JOUST_ROM_DIRECTORY)/3006-20.8b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_8b_3006-20.c6 \
$(JOUST_ROM_DIRECTORY)/3006-21.9b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_9b_3006-21.a6 \
$(JOUST_ROM_DIRECTORY)/3006-22.10b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_10b_3006-22.a7 \
$(JOUST_ROM_DIRECTORY)/3006-23.11b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_11b_3006-23.c7 \
$(JOUST_ROM_DIRECTORY)/3006-24.12b|$(JOUST_MAME_PACKAGE_DIRECTORY)/joust_rom_12b_3006-24.e7 \
$(JOUST_ROM_DIRECTORY)/joust.snd|$(JOUST_MAME_PACKAGE_DIRECTORY)/video_sound_rom_4_std_780.ic12 \
$(JOUST_ROM_DIRECTORY)/decoder.4|$(JOUST_MAME_PACKAGE_DIRECTORY)/decoder_rom_4.3g \
$(JOUST_ROM_DIRECTORY)/decoder.6|$(JOUST_MAME_PACKAGE_DIRECTORY)/decoder_rom_6.3c
JOUST_MAME_REWRITE_ROM_FILES := $(foreach pair,$(JOUST_MAME_REWRITE_ROM_PAIRS),$(word 2,$(subst |, ,$(pair))))
JOUST_REWRITE_FILES = \
$(JOUST_REWRITE_ROM_FILES) \
$(JOUST_REWRITE_DECODER_ROM_FILES) \
...
$(JOUST_ROM_DIRECTORY)/joustr $(JOUST_ROM_DIRECTORY)/joustwr $(JOUST_MAME_PACKAGE_DIRECTORY): | $(JOUST_ROM_DIRECTORY)
	mkdir -p $@
...
define JOUST_MAME_REWRITE_ROM_RULE
$(word 2,$(subst |, ,$(1))): $(word 1,$(subst |, ,$(1))) | $(JOUST_MAME_PACKAGE_DIRECTORY)
	cp -f $$< $$@
endef

$(foreach rom_pair,$(JOUST_MAME_REWRITE_ROM_PAIRS),$(eval $(call JOUST_MAME_REWRITE_ROM_RULE,$(rom_pair))))

$(JOUST_REWRITE_ZIP): $(JOUST_MAME_REWRITE_ROM_FILES) joust.mk | $(JOUST_ROM_DIRECTORY)
	rm -f $@
	cd $(JOUST_MAME_PACKAGE_DIRECTORY)
	zip ../$(notdir $@) $(notdir $(JOUST_MAME_REWRITE_ROM_FILES))
